      ...
      <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div class="container px-5">
                    <a class="navbar-brand" href="index.html"><span class="fw-bolder text-primary"><?php echo  $_SESSION["status"] ?></span></a>
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                            <li class="nav-item"><a class="nav-link" href="index.php">Hem</a></li>
                            <li class="nav-item"><a class="nav-link" href="logout.php">Avsluta</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
                ...
                <div class="container px-5 pb-5">
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            ...
                            <!-- Header text content-->
                          <?php if ($_SESSION["valid_user"]) { // We have a valid ticket.?>

                            <div class="text-center text-xxl-start">
                                <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase"><?php print($_SESSION["full_name"]); ?></div></div>
				<?php if ($_SESSION["running"]) { ?>
                                  <div class="fs-3 fw-light text-muted">
				    <?php include $incbase . '/list.php'; ?>
				  </div>
				<?php } else { ?>
                                  <div class="fs-3 fw-light text-muted">
				    <?php include $incbase . '/list.php'; ?>
	                  ...
	                  <?php
			    } else { // No valid ticket, write out the form.
			      include $incbase . '/login.php';
                            } // End of valid user if case.
			  ?>
